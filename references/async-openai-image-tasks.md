...
当 `gpt-image-2-oai` 用于创作 AI 视频分镜、关键帧草图、镜头视觉预览时，尺寸选择优先跟最终视频画幅一致，避免后续视频生成、剪辑或转场时二次裁切。本区只面向 AI 视频分镜，不与电商图尺寸建议混用。

#### 1K 分镜草图尺寸

适合快速探索镜头构图、角色站位、场景气氛和提示词方向，成本较低，适合批量出草稿。

- `16:9` 横版视频草图 / YouTube 草图：`1280x720`
  常见参数：`size=1280x720`
- `9:16` 竖版短视频草图 / TikTok / Reels / 小红书视频：`720x1280`
  常见参数：`size=720x1280`
- 方形视频草图 / 社媒方形预览：`1024x1024`
  常见参数：`size=1024x1024`
- 超宽电影镜头草图 / 氛围镜头预览：`1344x576`
  常见参数：`size=1344x576`
- 4:3 叙事分镜草图 / 多角色构图：`1024x768`
  常见参数：`size=1024x768`
- 3:4 竖构图草图 / 人物半身镜头：`768x1024`
  常见参数：`size=768x1024`

#### 2K 分镜推荐尺寸

默认优先使用 `2K` 档做正式分镜，兼顾清晰度、速度和后续裁切空间，适合作为视频模型参考图或导演分镜板。

- `16:9` 横版视频 / 电影感分镜 / YouTube：`2048x1152`
  常见参数：`size=2048x1152`
- `9:16` 竖版短视频 / TikTok / Reels / 小红书视频：`1152x2048`
  常见参数：`size=1152x2048`
- 方形视频 / 社媒方形预览：`2048x2048`
  常见参数：`size=2048x2048`
- 超宽电影镜头 / 横向氛围镜头：`2400x1024`
  常见参数：`size=2400x1024`
- 4:3 叙事分镜 / 复古电视感 / 多角色构图：`2048x1536`
  常见参数：`size=2048x1536`
- 3:4 竖构图分镜 / 人物半身镜头 / 移动端故事板：`1536x2048`
  常见参数：`size=1536x2048`

#### 4K 高精分镜尺寸

适合高质量视频参考图、复杂场景、后期裁切、投放级预览或需要保留更多细节的关键镜头。成本和生成时间通常更高，不建议草稿阶段默认使用。

- `16:9` 横版高精分镜 / 大屏预览 / 电影关键帧：`3840x2160`
  常见参数：`size=3840x2160`
- `9:16` 竖版高精分镜 / 移动端开屏视频参考：`2160x3840`
  常见参数：`size=2160x3840`
- 方形高精分镜 / 方形广告视频参考：`2048x2048`
  常见参数：`size=2048x2048`
- 超宽高精电影镜头 / 舞台感镜头：`3840x1648`
  常见参数：`size=3840x1648`
- 4:3 高精叙事分镜 / 多角色场景：`3328x2496`
  常见参数：`size=3328x2496`
- 3:4 高精竖构图分镜 / 人物镜头：`2496x3328`
  常见参数：`size=2496x3328`

分镜经验建议：

- 快速探索镜头构图用 `1K`，正式分镜默认用 `2K`，关键镜头或视频模型参考图再升到 `4K`。
- 同一组分镜必须保持相同 `size` 和画幅比例，避免角色位置、镜头运动和剪辑节奏不连续。
- 需要同时支持横竖版投放时，先定主版本画幅；不要在同一组分镜里混用 `16:9` 和 `9:16`。
- 若后续会交给视频生成模型，优先选择最终视频同画幅的 `2K` 尺寸：`16:9` 横版 `2048x1152`，`9:16` 竖版 `1152x2048`，方形 `2048x2048`。
