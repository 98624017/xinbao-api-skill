...
当 `gpt-image-2-oai` 用于创作 AI 视频分镜、关键帧草图、镜头视觉预览时，尺寸选择优先跟最终视频画幅一致，避免后续视频生成、剪辑或转场时二次裁切。

- 横版视频 / 电影感分镜 / YouTube：优先 `2048x1152`，需要更高清可用 `3840x2160`
  常见参数：`size=2048x1152`
- 竖版短视频 / TikTok / Reels / 小红书视频：优先 `1152x2048`，需要更高清可用 `2160x3840`
  常见参数：`size=1152x2048`
- 方形视频 / 社媒方形预览：优先 `2048x2048`
  常见参数：`size=2048x2048`
- 超宽电影镜头 / 横向氛围镜头：优先 `2400x1024`，需要舞台感或大屏预览可用 `3840x1648`
  常见参数：`size=2400x1024`
- 4:3 叙事分镜 / 复古电视感 / 多角色构图：优先 `2048x1536`
  常见参数：`size=2048x1536`
- 3:4 竖构图分镜 / 人物半身镜头 / 移动端故事板：优先 `1536x2048`
  常见参数：`size=1536x2048`

分镜经验建议：

- 默认用 `2K` 档做分镜，兼顾清晰度、速度和后续裁切空间。
- 如果只是快速探索镜头构图，可用 `1280x720` 或 `720x1280` 降低成本。
- 如果要给视频模型做高质量参考图，优先 `2048x1152`、`1152x2048`、`2048x2048`。
