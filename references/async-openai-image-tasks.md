...
- 横版视频草图 / YouTube 草图：`1280x720`
  常见参数：`size=1280x720`
- 竖版短视频草图 / TikTok / Reels / 小红书视频：`720x1280`
  常见参数：`size=720x1280`
...
- 横版视频 / 电影感分镜 / YouTube：`2048x1152`
  常见参数：`size=2048x1152`
- 竖版短视频 / TikTok / Reels / 小红书视频：`1152x2048`
  常见参数：`size=1152x2048`
...
- 横版高精分镜 / 大屏预览 / 电影关键帧：`3840x2160`
  常见参数：`size=3840x2160`
- 竖版高精分镜 / 移动端开屏视频参考：`2160x3840`
  常见参数：`size=2160x3840`
...
- 若后续会交给视频生成模型，优先选择最终视频同画幅的 `2K` 尺寸：横版 `2048x1152`，竖版 `1152x2048`，方形 `2048x2048`。
